...
io.on("connection", async (socket) => {
  ...
  socket.on("create_room", async (data) => {
    const rm = rooms.find(room => room.name === data);
    if (rm === undefined) {
...
const transferhistories = require('./routes/transferhistories');
const players_route = require('./routes/players');
//const gamehistories = require('./routes/gamehistories');
const financehistories = require('./routes/financehistories');
...
app.use('/users', urlencodedParser, users);
app.use('/transferhistories', urlencodedParser, transferhistories);
app.use('/players',urlencodedParser, players_route);
//app.use('/gamehistories', urlencodedParser, gamehistories);
app.use('/financehistories', urlencodedParser, financehistories);
app.use('/auth', urlencodedParser, auth);
